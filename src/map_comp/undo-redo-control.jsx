...
/**
 * Undo-Redo control component for the map
 * @param {Object} props - Component props
 * @param {google.maps.drawing.DrawingManager|null} props.drawingManager - The drawing manager
 */
export const UndoRedoControl = ({drawingManager}) => {
  const map = useMap();

 const {state,dispatch,overlaysShouldUpdateRef}=useDrawingContext()
// setdata(state);
console.log(state);
